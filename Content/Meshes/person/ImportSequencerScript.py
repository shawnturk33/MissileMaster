...
#Use this command : unreal_engine.py_exec(r"D:\2019au\etgg3801\assets\ExportedFbx\ImportSequencerScript.py")
...
def CreateSequencer():
	...
	camera_cut_section.sequencer_set_section_range(1/frameRateNumerator, (72-secureCrop)/frameRateNumerator)
